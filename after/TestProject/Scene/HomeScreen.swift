    ...
    var tabContentView : some View {
        VStack(spacing: 16) {
            TabView(selection: $currentTab) {
                HomeTabScreen(isShowHomeScreen: $isShowHomeScreen)
                    .tag("house.fill")
                SearchTabScreen(isShowHomeScreen: $isShowHomeScreen)
                    .tag("cross")
                TestTabScreen(isShowHomeScreen: $isShowHomeScreen)
                    .tag("eye")
                ProfileTabScreen(isShowHomeScreen: $isShowHomeScreen)
                    .tag("suit.heart")
                SettingTabScreen(isShowHomeScreen: $isShowHomeScreen)
                    .tag("person.circle")
            }
